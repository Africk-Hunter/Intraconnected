    ...
    return (
        <section className="textSection">
            ...
            <section className="helpGrid">
                ...
                <div className="helpGridIcon helpChecklist">Check<br />list</div><p className="details">Indigo nodes are check lists. Click the header to open the full check list view, or manage items directly on the card. Check lists cannot have child ideas.</p>
            </section>
        </section>
    );
};
